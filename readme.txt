=== Headers, Footers & Blocks for Elementor ===
...
Donate link: https://www.paypal.me/XplodedThemes
...
Create header and footer of your site easily using [Elementor](https://elementor.com/ "Elementor").
...
= Features of XT Elementor Header Footer =
...
1. <a href="https://wpbrava.com">Brava</a> - The Fastest, Most Lightweight &amp; Customizable WordPress Theme.
2. GeneratePress.
3. OceanWP.
4. Genesis.
5. Phlox Theme.

If you are a theme developer you can add support for the XT Elementor Header Footer from your theme easily. <a href="https://github.com/xplodedthemes/xt-elementor-header-footer/wiki/Adding-Header-Footer-Elementor-support-for-your-theme">Read instructions here</a>.

== Installation ==

1. Go to `Plugins -> Add New` and search for XT Elementor Header Footer.
...
If you are a theme developer <a href="https://github.com/xplodedthemes/xt-elementor-header-footer/wiki/Adding-Header-Footer-Elementor-support-for-your-theme">here</a> is a quick tutorial on how you can add support for the XT Elementor Header Footer from your theme.
...
= How Can I add support for Header/Footer Plugin from my theme? =

If you are a theme developer <a href="https://github.com/xplodedthemes/xt-elementor-header-footer/wiki/Adding-Header-Footer-Elementor-support-for-your-theme">here</a> is a quick tutorial on how you can add support for the XT Elementor Header Footer from your theme.

If you are using a pre-made theme, The best approach would be to contact yoru theme developer and provide them link to the <a href="https://github.com/xplodedthemes/xt-elementor-header-footer/wiki/Adding-Header-Footer-Elementor-support-for-your-theme">Wiki article</a> on how they can add support for the plugin. 
If the above is nnot possible, You can also add support for the plugin from your child theme. Just follow <a href="https://github.com/xplodedthemes/xt-elementor-header-footer/wiki/Add-support-to-Header-Footer-Elementor-from-the-Child-Theme">this article</a>
...
= 1.1.2 =
- Fix: Deprecated function warning from Elementor's method `\Elementor\Post_CSS_File`
...
= 1.0.16 =
- Fix: Make the theme not supported notice dismissible.
...
- Fix: Load the elementor header assets correctly in header. This fixes header looking different just when loading the page as previously Elementor would load it's CSS in the footer.
- Introduced helper functions for rendering and checking the headers to make it simpler to integrate XT_EHF with more themes.

= 1.0.1 =
- New: Added support for the <a href="https://wpbrava.com">Brava</a> WordPress theme - The Fastest, Most Lightweight &amp; Customizable WordPress Theme.
