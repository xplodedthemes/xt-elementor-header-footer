 ...
 */
class XT_EHF_Astra_Compat {

	/**
	 * Instance of XT_EHF_Astra_Compat.
	 *
	 * @var XT_EHF_Astra_Compat
	 */
	...
	public static function instance() {
		...
		if ( ! isset( self::$instance ) ) {
			self::$instance = new XT_EHF_Astra_Compat();
	...
	public function hooks() {
		...
		if ( xt_ehf_header_enabled() ) {
			...
			add_action( 'astra_header', 'xt_ehf_render_header' );
		}

		if ( xt_ehf_footer_enabled() ) {
			add_action( 'template_redirect', array( $this, 'astra_setup_footer' ), 10 );
			add_action( 'astra_footer', 'xt_ehf_render_footer' );
		}
